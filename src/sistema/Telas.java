...
public class Telas {
	...
	public static <ContaPoupanca> void telaSaque(Usuario usuarioLogado, Object contaLogada, Map<String, ContaCorrente> mapaContaCorrente,
	...
	public static <ContaPoupanca> void telaDeposito(Usuario usuarioLogado, ContaPoupanca contaLogada,
		...
		if (mapaContaCorrente.get(usuarioLogado.getCpf()) != null) {
			...
			try {
				cc.deposito(valor);
			} catch (exceptions.ValorInvalidoException e) {
				System.out.println(e);
			}
		}
